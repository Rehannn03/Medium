...
export default function Alert({message}: {message: string}) {
  return (
    <div x-data="{ modal: true }" className="py-8 px-6">
  <div className="p-6 bg-white border-l-4 border-indigo-500 shadow-md rounded-r-lg">
    <div className="flex items-center">
      <h3 className="text-indigo-800 font-medium">{message}</h3>
      <button x-on:click="modal = false" className="ml-auto">
        <svg className="text-indigo-800" width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
